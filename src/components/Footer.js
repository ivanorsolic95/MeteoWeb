...
const navigation = {
    social: [
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/orsolicivan/',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/ivann_ors/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/orsolic_ivan1',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/ivanorsolic95/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
